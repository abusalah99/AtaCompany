...
namespace AtaCompany.Migrations
{
    ...
    [Migration("20231022091254_ModifyContractor")]
    partial class ModifyContractor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtaCompany.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("LocationId", "ContractorId");
            ...
            modelBuilder.Entity("AtaCompany.Payment", b =>
                {
                    b.HasOne("AtaCompany.LocationContractor", "LocationContractor")
                        .WithMany("Payments")
                        .HasForeignKey("LocationId", "ContractorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LocationContractor");
                });
